...
label_result= Label(root,width=25,height=2,fg="white",bg="black",text='',font=('Arial',30,'bold'))
label_result.pack()

Button(root,text="C", width=5,height=1, font=("arial",30,"bold"), bd=1, fg="#fff",bg="#3697f5",command=lambda :clear("C")).place(x=10,y=100)
